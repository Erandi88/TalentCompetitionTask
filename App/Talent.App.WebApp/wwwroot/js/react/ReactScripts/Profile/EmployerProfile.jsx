...
export default class EmployeeProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            ...
            url: 'https://talentserviceprofilecompetitions.azurewebsites.net/profile/profile/getEmployerProfile',
            headers: {
    ...
    saveData() {
        ...
        $.ajax({
           // url: 'http://localhost:60290/profile/profile/saveEmployerProfile',
            url: 'https://talentserviceprofilecompetitions.azurewebsites.net/profile/profile/saveEmployerProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
